                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">York St John</a>
...
<div>
<blockquote><p>
     <h2 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">York St John University</h2>
     <h3 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">The university where you'll shape your future</h3> 
</blockquote>
<!-- Page content -->
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="technologies">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16" align="center">COURSES</h3>
  </div>
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">York St John University is a high quality, friendly university with a campus based in the centre of the historic City of York.
	    </p>
	    <p><strong>Address:</strong>  Lord Mayor's Walk, York YO31 7EX</p> 
	    <p><strong>Ph No: </strong>  +01904 624624</p>
		<p><strong>E-Mail ID :</strong>  aminemadani@gmail.com </p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright 2023 <a href="#"  target="_blank" class="w3-hover-text-green"> aminemadani@gmail.com</a></p>
</footer>
